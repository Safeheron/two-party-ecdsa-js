...
class Message3 {
    constructor(proof_PailN, N, cypher_x1, proof_Q1, blind) {
    ...
    toProtobuf() {
        return two_party_ecdsa_key_gen_1.two_party_ecdsa_key_gen.Message3.encode(jsonObject_1.JsonObject.fromMessage3(this)).finish();
    }
    static fromProtobuf(bytes) {
        const model = two_party_ecdsa_key_gen_1.two_party_ecdsa_key_gen.Message3.decode(bytes);
