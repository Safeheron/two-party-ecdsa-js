...
$root.two_party_ecdsa_sign = (function () {
    /**
     * Namespace two_party_ecdsa_sign.
     * @exports two_party_ecdsa_sign
     * @namespace
     */
    var two_party_ecdsa_sign = {};
    two_party_ecdsa_sign.Message1 = (function () {
        /**
         * Properties of a Message1.
         * @memberof two_party_ecdsa_sign
         * @interface IMessage1
         * @property {string|null} [commitment_R1] Message1 commitment_R1
         */
        /**
         ...
         * @constructor
         * @param {two_party_ecdsa_sign.IMessage1=} [properties] Properties to set
         */
         ...
         * @member {string} commitment_R1
         * @memberof two_party_ecdsa_sign.Message1
         * @instance
         */
        Message1.prototype.commitment_R1 = "";
        /**
         ...
         * @static
         * @param {two_party_ecdsa_sign.IMessage1=} [properties] Properties to set
         * @returns {two_party_ecdsa_sign.Message1} Message1 instance
         */
         ...
         * @memberof two_party_ecdsa_sign.Message1
         * @static
         * @param {two_party_ecdsa_sign.IMessage1} message Message1 message or plain object to encode
        ...
        Message1.encode = function encode(message, writer) {
            ...
            if (message.commitment_R1 != null && Object.hasOwnProperty.call(message, "commitment_R1"))
                writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.commitment_R1);
            return writer;
        };
        /**
         ...
         * @returns {two_party_ecdsa_sign.Message1} Message1
        ...
        Message1.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.two_party_ecdsa_sign.Message1();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
                        message.commitment_R1 = reader.string();
                        break;
                    default:
        ...
        Message1.verify = function verify(message) {
            ...
            if (message.commitment_R1 != null && message.hasOwnProperty("commitment_R1"))
                if (!$util.isString(message.commitment_R1))
                    return "commitment_R1: string expected";
            return null;
        };
        /**
        ...
        Message1.fromObject = function fromObject(object) {
            if (object instanceof $root.two_party_ecdsa_sign.Message1)
                return object;
            var message = new $root.two_party_ecdsa_sign.Message1();
            if (object.commitment_R1 != null)
                message.commitment_R1 = String(object.commitment_R1);
            return message;
        };
        /**
         ...
         * @memberof two_party_ecdsa_sign.Message1
         * @static
         * @param {two_party_ecdsa_sign.Message1} message Message1
        ...
        Message1.toObject = function toObject(message, options) {
            ...
            var object = {};
            if (options.defaults)
                object.commitment_R1 = "";
            if (message.commitment_R1 != null && message.hasOwnProperty("commitment_R1"))
                object.commitment_R1 = message.commitment_R1;
            return object;
        };
        /**
    ...
    two_party_ecdsa_sign.Message2 = (function () {
        /**
         * Properties of a Message2.
         * @memberof two_party_ecdsa_sign
         * @interface IMessage2
         * @property {basic_type.ISchnorrProof|null} [proof_R2] Message2 proof_R2
         */
        /**
         ...
         * @constructor
         * @param {two_party_ecdsa_sign.IMessage2=} [properties] Properties to set
         */
        ...
        /**
         * Message2 proof_R2.
         * @member {basic_type.ISchnorrProof|null|undefined} proof_R2
         * @memberof two_party_ecdsa_sign.Message2
         * @instance
         */
        Message2.prototype.proof_R2 = null;
        /**
         ...
         * @static
         * @param {two_party_ecdsa_sign.IMessage2=} [properties] Properties to set
         * @returns {two_party_ecdsa_sign.Message2} Message2 instance
         */
         ...
         * @memberof two_party_ecdsa_sign.Message2
         * @static
         * @param {two_party_ecdsa_sign.IMessage2} message Message2 message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        Message2.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.proof_R2 != null && Object.hasOwnProperty.call(message, "proof_R2"))
                $root.basic_type.SchnorrProof.encode(message.proof_R2, writer.uint32(/* id 1, wireType 2 =*/ 10).fork()).ldelim();
            return writer;
        };
        /**
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {two_party_ecdsa_sign.Message2} Message2
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Message2.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.two_party_ecdsa_sign.Message2();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
                        message.proof_R2 = $root.basic_type.SchnorrProof.decode(reader, reader.uint32());
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
        ...
        Message2.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.proof_R2 != null && message.hasOwnProperty("proof_R2")) {
                var error = $root.basic_type.SchnorrProof.verify(message.proof_R2);
                if (error)
                    return "proof_R2." + error;
            }
            return null;
        };
        /**
        ...
        Message2.fromObject = function fromObject(object) {
            if (object instanceof $root.two_party_ecdsa_sign.Message2)
                return object;
            var message = new $root.two_party_ecdsa_sign.Message2();
            if (object.proof_R2 != null) {
                if (typeof object.proof_R2 !== "object")
                    throw TypeError(".two_party_ecdsa_sign.Message2.proof_R2: object expected");
                message.proof_R2 = $root.basic_type.SchnorrProof.fromObject(object.proof_R2);
            }
            return message;
        };
        /**
         ...
         * @memberof two_party_ecdsa_sign.Message2
         * @static
         * @param {two_party_ecdsa_sign.Message2} message Message2
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        Message2.toObject = function toObject(message, options) {
            ...
            var object = {};
            if (options.defaults)
                object.proof_R2 = null;
            if (message.proof_R2 != null && message.hasOwnProperty("proof_R2"))
                object.proof_R2 = $root.basic_type.SchnorrProof.toObject(message.proof_R2, options);
            return object;
        };
        /**
    ...
    two_party_ecdsa_sign.Message3 = (function () {
        /**
         * Properties of a Message3.
         * @memberof two_party_ecdsa_sign
         * @interface IMessage3
         * @property {basic_type.ISchnorrProof|null} [proof_R1] Message3 proof_R1
         ...
         * @constructor
         * @param {two_party_ecdsa_sign.IMessage3=} [properties] Properties to set
         */
        ...
        /**
         * Message3 proof_R1.
         * @member {basic_type.ISchnorrProof|null|undefined} proof_R1
         * @memberof two_party_ecdsa_sign.Message3
         * @instance
         */
        Message3.prototype.proof_R1 = null;
        /**
         * Message3 blind.
         * @member {string} blind
         * @memberof two_party_ecdsa_sign.Message3
         ...
         * @static
         * @param {two_party_ecdsa_sign.IMessage3=} [properties] Properties to set
         * @returns {two_party_ecdsa_sign.Message3} Message3 instance
         */
         ...
         * @memberof two_party_ecdsa_sign.Message3
         * @static
         * @param {two_party_ecdsa_sign.IMessage3} message Message3 message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        Message3.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.proof_R1 != null && Object.hasOwnProperty.call(message, "proof_R1"))
                $root.basic_type.SchnorrProof.encode(message.proof_R1, writer.uint32(/* id 1, wireType 2 =*/ 10).fork()).ldelim();
            if (message.blind != null && Object.hasOwnProperty.call(message, "blind"))
                writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.blind);
            return writer;
        };
        /**
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {two_party_ecdsa_sign.Message3} Message3
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Message3.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.two_party_ecdsa_sign.Message3();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
                        message.proof_R1 = $root.basic_type.SchnorrProof.decode(reader, reader.uint32());
                        break;
                    case 2:
        ...
        Message3.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.proof_R1 != null && message.hasOwnProperty("proof_R1")) {
                var error = $root.basic_type.SchnorrProof.verify(message.proof_R1);
                if (error)
                    return "proof_R1." + error;
            }
        ...
        Message3.fromObject = function fromObject(object) {
            if (object instanceof $root.two_party_ecdsa_sign.Message3)
                return object;
            var message = new $root.two_party_ecdsa_sign.Message3();
            if (object.proof_R1 != null) {
                if (typeof object.proof_R1 !== "object")
                    throw TypeError(".two_party_ecdsa_sign.Message3.proof_R1: object expected");
                message.proof_R1 = $root.basic_type.SchnorrProof.fromObject(object.proof_R1);
            }
         ...
         * @memberof two_party_ecdsa_sign.Message3
         * @static
         * @param {two_party_ecdsa_sign.Message3} message Message3
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        Message3.toObject = function toObject(message, options) {
            ...
            var object = {};
            if (options.defaults) {
                object.proof_R1 = null;
                object.blind = "";
            }
            if (message.proof_R1 != null && message.hasOwnProperty("proof_R1"))
                object.proof_R1 = $root.basic_type.SchnorrProof.toObject(message.proof_R1, options);
            if (message.blind != null && message.hasOwnProperty("blind"))
    ...
    two_party_ecdsa_sign.Message4 = (function () {
        /**
         * Properties of a Message4.
         * @memberof two_party_ecdsa_sign
         * @interface IMessage4
         * @property {string|null} [cypher3] Message4 cypher3
         */
        /**
         * Constructs a new Message4.
         * @memberof two_party_ecdsa_sign
         * @classdesc Represents a Message4.
         * @implements IMessage4
         * @constructor
         * @param {two_party_ecdsa_sign.IMessage4=} [properties] Properties to set
         */
        ...
        /**
         * Message4 cypher3.
         * @member {string} cypher3
         * @memberof two_party_ecdsa_sign.Message4
         * @instance
         */
        Message4.prototype.cypher3 = "";
        /**
         ...
         * @static
         * @param {two_party_ecdsa_sign.IMessage4=} [properties] Properties to set
         * @returns {two_party_ecdsa_sign.Message4} Message4 instance
         */
        Message4.create = function create(properties) {
            return new Message4(properties);
        };
        /**
         ...
         * @memberof two_party_ecdsa_sign.Message4
         * @static
         * @param {two_party_ecdsa_sign.IMessage4} message Message4 message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        Message4.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.cypher3 != null && Object.hasOwnProperty.call(message, "cypher3"))
                writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.cypher3);
            return writer;
        };
        /**
         ...
         * @returns {$protobuf.Writer} Writer
         */
        Message4.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        /**
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {two_party_ecdsa_sign.Message4} Message4
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Message4.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.two_party_ecdsa_sign.Message4();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
                        message.cypher3 = reader.string();
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Message4.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        Message4.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.cypher3 != null && message.hasOwnProperty("cypher3"))
                if (!$util.isString(message.cypher3))
                    return "cypher3: string expected";
            return null;
        };
        /**
        ...
        Message4.fromObject = function fromObject(object) {
            if (object instanceof $root.two_party_ecdsa_sign.Message4)
                return object;
            var message = new $root.two_party_ecdsa_sign.Message4();
            if (object.cypher3 != null)
                message.cypher3 = String(object.cypher3);
            return message;
        };
        /**
         ...
         * @memberof two_party_ecdsa_sign.Message4
         * @static
         * @param {two_party_ecdsa_sign.Message4} message Message4
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        Message4.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults)
                object.cypher3 = "";
            if (message.cypher3 != null && message.hasOwnProperty("cypher3"))
                object.cypher3 = message.cypher3;
            return object;
        };
        /**
...
module.exports = $root;
//# sourceMappingURL=two_party_ecdsa_sign.js.map