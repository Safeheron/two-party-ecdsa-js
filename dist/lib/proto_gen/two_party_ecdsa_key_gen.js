...
$root.two_party_ecdsa_key_gen = (function () {
    /**
     * Namespace two_party_ecdsa_key_gen.
     * @exports two_party_ecdsa_key_gen
     * @namespace
     */
    var two_party_ecdsa_key_gen = {};
    two_party_ecdsa_key_gen.Message1 = (function () {
        /**
         * Properties of a Message1.
         * @memberof two_party_ecdsa_key_gen
         * @interface IMessage1
         * @property {string|null} [commitment_Q1] Message1 commitment_Q1
         */
        /**
         ...
         * @constructor
         * @param {two_party_ecdsa_key_gen.IMessage1=} [properties] Properties to set
         */
         ...
         * @member {string} commitment_Q1
         * @memberof two_party_ecdsa_key_gen.Message1
         * @instance
         */
        Message1.prototype.commitment_Q1 = "";
        /**
         ...
         * @static
         * @param {two_party_ecdsa_key_gen.IMessage1=} [properties] Properties to set
         * @returns {two_party_ecdsa_key_gen.Message1} Message1 instance
         */
         ...
         * @memberof two_party_ecdsa_key_gen.Message1
         * @static
         * @param {two_party_ecdsa_key_gen.IMessage1} message Message1 message or plain object to encode
        ...
        Message1.encode = function encode(message, writer) {
            ...
            if (message.commitment_Q1 != null && Object.hasOwnProperty.call(message, "commitment_Q1"))
                writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.commitment_Q1);
            return writer;
        };
        /**
         ...
         * @returns {two_party_ecdsa_key_gen.Message1} Message1
        ...
        Message1.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.two_party_ecdsa_key_gen.Message1();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
                        message.commitment_Q1 = reader.string();
                        break;
                    default:
        ...
        Message1.verify = function verify(message) {
            ...
            if (message.commitment_Q1 != null && message.hasOwnProperty("commitment_Q1"))
                if (!$util.isString(message.commitment_Q1))
                    return "commitment_Q1: string expected";
            return null;
        };
        /**
        ...
        Message1.fromObject = function fromObject(object) {
            if (object instanceof $root.two_party_ecdsa_key_gen.Message1)
                return object;
            var message = new $root.two_party_ecdsa_key_gen.Message1();
            if (object.commitment_Q1 != null)
                message.commitment_Q1 = String(object.commitment_Q1);
            return message;
        };
        /**
         ...
         * @memberof two_party_ecdsa_key_gen.Message1
         * @static
         * @param {two_party_ecdsa_key_gen.Message1} message Message1
        ...
        Message1.toObject = function toObject(message, options) {
            ...
            var object = {};
            if (options.defaults)
                object.commitment_Q1 = "";
            if (message.commitment_Q1 != null && message.hasOwnProperty("commitment_Q1"))
                object.commitment_Q1 = message.commitment_Q1;
            return object;
        };
        /**
    ...
    two_party_ecdsa_key_gen.Message2 = (function () {
        /**
         * Properties of a Message2.
         * @memberof two_party_ecdsa_key_gen
         * @interface IMessage2
         * @property {basic_type.ISchnorrProof|null} [proof_Q2] Message2 proof_Q2
         */
        /**
         * Constructs a new Message2.
         * @memberof two_party_ecdsa_key_gen
         * @classdesc Represents a Message2.
         * @implements IMessage2
         * @constructor
         * @param {two_party_ecdsa_key_gen.IMessage2=} [properties] Properties to set
         */
        ...
        /**
         * Message2 proof_Q2.
         * @member {basic_type.ISchnorrProof|null|undefined} proof_Q2
         * @memberof two_party_ecdsa_key_gen.Message2
         * @instance
         */
        Message2.prototype.proof_Q2 = null;
        /**
         ...
         * @static
         * @param {two_party_ecdsa_key_gen.IMessage2=} [properties] Properties to set
         * @returns {two_party_ecdsa_key_gen.Message2} Message2 instance
         */
         ...
         * @memberof two_party_ecdsa_key_gen.Message2
         * @static
         * @param {two_party_ecdsa_key_gen.IMessage2} message Message2 message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        Message2.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.proof_Q2 != null && Object.hasOwnProperty.call(message, "proof_Q2"))
                $root.basic_type.SchnorrProof.encode(message.proof_Q2, writer.uint32(/* id 1, wireType 2 =*/ 10).fork()).ldelim();
            return writer;
        };
        /**
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {two_party_ecdsa_key_gen.Message2} Message2
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Message2.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.two_party_ecdsa_key_gen.Message2();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
                        message.proof_Q2 = $root.basic_type.SchnorrProof.decode(reader, reader.uint32());
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
        ...
        Message2.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.proof_Q2 != null && message.hasOwnProperty("proof_Q2")) {
                var error = $root.basic_type.SchnorrProof.verify(message.proof_Q2);
                if (error)
                    return "proof_Q2." + error;
            }
            return null;
        };
        /**
        ...
        Message2.fromObject = function fromObject(object) {
            if (object instanceof $root.two_party_ecdsa_key_gen.Message2)
                return object;
            var message = new $root.two_party_ecdsa_key_gen.Message2();
            if (object.proof_Q2 != null) {
                if (typeof object.proof_Q2 !== "object")
                    throw TypeError(".two_party_ecdsa_key_gen.Message2.proof_Q2: object expected");
                message.proof_Q2 = $root.basic_type.SchnorrProof.fromObject(object.proof_Q2);
            }
            return message;
        };
        /**
         ...
         * @memberof two_party_ecdsa_key_gen.Message2
         * @static
         * @param {two_party_ecdsa_key_gen.Message2} message Message2
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        Message2.toObject = function toObject(message, options) {
            ...
            var object = {};
            if (options.defaults)
                object.proof_Q2 = null;
            if (message.proof_Q2 != null && message.hasOwnProperty("proof_Q2"))
                object.proof_Q2 = $root.basic_type.SchnorrProof.toObject(message.proof_Q2, options);
            return object;
        };
        /**
    ...
    two_party_ecdsa_key_gen.Message3 = (function () {
        /**
         * Properties of a Message3.
         * @memberof two_party_ecdsa_key_gen
         * @interface IMessage3
         * @property {basic_type.IPailProof|null} [proof_pailN] Message3 proof_pailN
         * @property {string|null} [N] Message3 N
         * @property {string|null} [cypher_x1] Message3 cypher_x1
         * @property {basic_type.ISchnorrProof|null} [proof_Q1] Message3 proof_Q1
         * @property {string|null} [blind] Message3 blind
         */
        /**
         * Constructs a new Message3.
         * @memberof two_party_ecdsa_key_gen
         * @classdesc Represents a Message3.
         * @implements IMessage3
         * @constructor
         * @param {two_party_ecdsa_key_gen.IMessage3=} [properties] Properties to set
         */
         ...
         * @member {basic_type.IPailProof|null|undefined} proof_pailN
         * @memberof two_party_ecdsa_key_gen.Message3
         * @instance
         */
        Message3.prototype.proof_pailN = null;
        /**
         * Message3 N.
         * @member {string} N
         * @memberof two_party_ecdsa_key_gen.Message3
         * @instance
         */
        Message3.prototype.N = "";
        /**
         * Message3 cypher_x1.
         * @member {string} cypher_x1
         * @memberof two_party_ecdsa_key_gen.Message3
         * @instance
         */
        Message3.prototype.cypher_x1 = "";
        /**
         * Message3 proof_Q1.
         * @member {basic_type.ISchnorrProof|null|undefined} proof_Q1
         * @memberof two_party_ecdsa_key_gen.Message3
         * @instance
         */
        Message3.prototype.proof_Q1 = null;
        /**
         * Message3 blind.
         * @member {string} blind
         * @memberof two_party_ecdsa_key_gen.Message3
         ...
         * @static
         * @param {two_party_ecdsa_key_gen.IMessage3=} [properties] Properties to set
         * @returns {two_party_ecdsa_key_gen.Message3} Message3 instance
         */
        Message3.create = function create(properties) {
            return new Message3(properties);
        };
        /**
         ...
         * @memberof two_party_ecdsa_key_gen.Message3
         * @static
         * @param {two_party_ecdsa_key_gen.IMessage3} message Message3 message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        Message3.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.proof_pailN != null && Object.hasOwnProperty.call(message, "proof_pailN"))
                $root.basic_type.PailProof.encode(message.proof_pailN, writer.uint32(/* id 1, wireType 2 =*/ 10).fork()).ldelim();
            if (message.N != null && Object.hasOwnProperty.call(message, "N"))
                writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.N);
            if (message.cypher_x1 != null && Object.hasOwnProperty.call(message, "cypher_x1"))
                writer.uint32(/* id 3, wireType 2 =*/ 26).string(message.cypher_x1);
            if (message.proof_Q1 != null && Object.hasOwnProperty.call(message, "proof_Q1"))
                $root.basic_type.SchnorrProof.encode(message.proof_Q1, writer.uint32(/* id 4, wireType 2 =*/ 34).fork()).ldelim();
            if (message.blind != null && Object.hasOwnProperty.call(message, "blind"))
                writer.uint32(/* id 5, wireType 2 =*/ 42).string(message.blind);
            return writer;
        };
        /**
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {two_party_ecdsa_key_gen.Message3} Message3
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Message3.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.two_party_ecdsa_key_gen.Message3();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
                        message.proof_pailN = $root.basic_type.PailProof.decode(reader, reader.uint32());
                        break;
                    case 2:
                        message.N = reader.string();
                        break;
                    case 3:
                        message.cypher_x1 = reader.string();
                        break;
                    case 4:
                        message.proof_Q1 = $root.basic_type.SchnorrProof.decode(reader, reader.uint32());
                        break;
                    case 5:
                        message.blind = reader.string();
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
        ...
        Message3.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.proof_pailN != null && message.hasOwnProperty("proof_pailN")) {
                var error = $root.basic_type.PailProof.verify(message.proof_pailN);
                if (error)
                    return "proof_pailN." + error;
            }
            if (message.N != null && message.hasOwnProperty("N"))
                if (!$util.isString(message.N))
                    return "N: string expected";
            if (message.cypher_x1 != null && message.hasOwnProperty("cypher_x1"))
                if (!$util.isString(message.cypher_x1))
                    return "cypher_x1: string expected";
            if (message.proof_Q1 != null && message.hasOwnProperty("proof_Q1")) {
                var error = $root.basic_type.SchnorrProof.verify(message.proof_Q1);
                if (error)
                    return "proof_Q1." + error;
            }
            if (message.blind != null && message.hasOwnProperty("blind"))
                if (!$util.isString(message.blind))
                    return "blind: string expected";
            return null;
        };
        /**
         ...
         * @returns {two_party_ecdsa_key_gen.Message3} Message3
         */
        Message3.fromObject = function fromObject(object) {
            if (object instanceof $root.two_party_ecdsa_key_gen.Message3)
                return object;
            var message = new $root.two_party_ecdsa_key_gen.Message3();
            if (object.proof_pailN != null) {
                if (typeof object.proof_pailN !== "object")
                    throw TypeError(".two_party_ecdsa_key_gen.Message3.proof_pailN: object expected");
                message.proof_pailN = $root.basic_type.PailProof.fromObject(object.proof_pailN);
            }
            if (object.N != null)
                message.N = String(object.N);
            if (object.cypher_x1 != null)
                message.cypher_x1 = String(object.cypher_x1);
            if (object.proof_Q1 != null) {
                if (typeof object.proof_Q1 !== "object")
                    throw TypeError(".two_party_ecdsa_key_gen.Message3.proof_Q1: object expected");
                message.proof_Q1 = $root.basic_type.SchnorrProof.fromObject(object.proof_Q1);
            }
            if (object.blind != null)
                message.blind = String(object.blind);
            return message;
        };
        /**
         ...
         * @memberof two_party_ecdsa_key_gen.Message3
         * @static
         * @param {two_party_ecdsa_key_gen.Message3} message Message3
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        Message3.toObject = function toObject(message, options) {
            ...
            var object = {};
            if (options.defaults) {
                object.proof_pailN = null;
                object.N = "";
                object.cypher_x1 = "";
                object.proof_Q1 = null;
                object.blind = "";
            }
            if (message.proof_pailN != null && message.hasOwnProperty("proof_pailN"))
                object.proof_pailN = $root.basic_type.PailProof.toObject(message.proof_pailN, options);
            if (message.N != null && message.hasOwnProperty("N"))
                object.N = message.N;
            if (message.cypher_x1 != null && message.hasOwnProperty("cypher_x1"))
                object.cypher_x1 = message.cypher_x1;
            if (message.proof_Q1 != null && message.hasOwnProperty("proof_Q1"))
                object.proof_Q1 = $root.basic_type.SchnorrProof.toObject(message.proof_Q1, options);
            if (message.blind != null && message.hasOwnProperty("blind"))
    ...
    two_party_ecdsa_key_gen.KeyShare1 = (function () {
        /**
         * Properties of a KeyShare1.
         * @memberof two_party_ecdsa_key_gen
         * @interface IKeyShare1
         * @property {string|null} [x1] KeyShare1 x1
         * @property {basic_type.ICurvePoint|null} [Q] KeyShare1 Q
         * @property {basic_type.IPailPub|null} [pailPubKey] KeyShare1 pailPubKey
         * @property {basic_type.IPailPriv|null} [pailPrivKey] KeyShare1 pailPrivKey
         */
        /**
         * Constructs a new KeyShare1.
         * @memberof two_party_ecdsa_key_gen
         * @classdesc Represents a KeyShare1.
         * @implements IKeyShare1
         * @constructor
         * @param {two_party_ecdsa_key_gen.IKeyShare1=} [properties] Properties to set
         */
        function KeyShare1(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * KeyShare1 x1.
         * @member {string} x1
         * @memberof two_party_ecdsa_key_gen.KeyShare1
         * @instance
         */
        KeyShare1.prototype.x1 = "";
        /**
         * KeyShare1 Q.
         * @member {basic_type.ICurvePoint|null|undefined} Q
         * @memberof two_party_ecdsa_key_gen.KeyShare1
         * @instance
         */
        KeyShare1.prototype.Q = null;
        /**
         * KeyShare1 pailPubKey.
         * @member {basic_type.IPailPub|null|undefined} pailPubKey
         * @memberof two_party_ecdsa_key_gen.KeyShare1
         * @instance
         */
        KeyShare1.prototype.pailPubKey = null;
        /**
         * KeyShare1 pailPrivKey.
         * @member {basic_type.IPailPriv|null|undefined} pailPrivKey
         * @memberof two_party_ecdsa_key_gen.KeyShare1
         * @instance
         */
        KeyShare1.prototype.pailPrivKey = null;
        /**
         ...
         * @static
         * @param {two_party_ecdsa_key_gen.IKeyShare1=} [properties] Properties to set
         * @returns {two_party_ecdsa_key_gen.KeyShare1} KeyShare1 instance
         */
        KeyShare1.create = function create(properties) {
            return new KeyShare1(properties);
        };
        /**
         ...
         * @memberof two_party_ecdsa_key_gen.KeyShare1
         * @static
         * @param {two_party_ecdsa_key_gen.IKeyShare1} message KeyShare1 message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        KeyShare1.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.x1 != null && Object.hasOwnProperty.call(message, "x1"))
                writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.x1);
            if (message.Q != null && Object.hasOwnProperty.call(message, "Q"))
                $root.basic_type.CurvePoint.encode(message.Q, writer.uint32(/* id 2, wireType 2 =*/ 18).fork()).ldelim();
            if (message.pailPubKey != null && Object.hasOwnProperty.call(message, "pailPubKey"))
                $root.basic_type.PailPub.encode(message.pailPubKey, writer.uint32(/* id 3, wireType 2 =*/ 26).fork()).ldelim();
            if (message.pailPrivKey != null && Object.hasOwnProperty.call(message, "pailPrivKey"))
                $root.basic_type.PailPriv.encode(message.pailPrivKey, writer.uint32(/* id 4, wireType 2 =*/ 34).fork()).ldelim();
            return writer;
        };
        /**
         ...
         * @returns {$protobuf.Writer} Writer
         */
        KeyShare1.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        /**
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {two_party_ecdsa_key_gen.KeyShare1} KeyShare1
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        KeyShare1.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.two_party_ecdsa_key_gen.KeyShare1();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
                        message.x1 = reader.string();
                        break;
                    case 2:
                        message.Q = $root.basic_type.CurvePoint.decode(reader, reader.uint32());
                        break;
                    case 3:
                        message.pailPubKey = $root.basic_type.PailPub.decode(reader, reader.uint32());
                        break;
                    case 4:
                        message.pailPrivKey = $root.basic_type.PailPriv.decode(reader, reader.uint32());
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        KeyShare1.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        KeyShare1.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.x1 != null && message.hasOwnProperty("x1"))
                if (!$util.isString(message.x1))
                    return "x1: string expected";
            if (message.Q != null && message.hasOwnProperty("Q")) {
                var error = $root.basic_type.CurvePoint.verify(message.Q);
                if (error)
                    return "Q." + error;
            }
            if (message.pailPubKey != null && message.hasOwnProperty("pailPubKey")) {
                var error = $root.basic_type.PailPub.verify(message.pailPubKey);
                if (error)
                    return "pailPubKey." + error;
            }
            if (message.pailPrivKey != null && message.hasOwnProperty("pailPrivKey")) {
                var error = $root.basic_type.PailPriv.verify(message.pailPrivKey);
                if (error)
                    return "pailPrivKey." + error;
            }
            return null;
        };
        /**
         ...
         * @returns {two_party_ecdsa_key_gen.KeyShare1} KeyShare1
         */
        KeyShare1.fromObject = function fromObject(object) {
            if (object instanceof $root.two_party_ecdsa_key_gen.KeyShare1)
                return object;
            var message = new $root.two_party_ecdsa_key_gen.KeyShare1();
            if (object.x1 != null)
                message.x1 = String(object.x1);
            if (object.Q != null) {
                if (typeof object.Q !== "object")
                    throw TypeError(".two_party_ecdsa_key_gen.KeyShare1.Q: object expected");
                message.Q = $root.basic_type.CurvePoint.fromObject(object.Q);
            }
            if (object.pailPubKey != null) {
                if (typeof object.pailPubKey !== "object")
                    throw TypeError(".two_party_ecdsa_key_gen.KeyShare1.pailPubKey: object expected");
                message.pailPubKey = $root.basic_type.PailPub.fromObject(object.pailPubKey);
            }
            if (object.pailPrivKey != null) {
                if (typeof object.pailPrivKey !== "object")
                    throw TypeError(".two_party_ecdsa_key_gen.KeyShare1.pailPrivKey: object expected");
                message.pailPrivKey = $root.basic_type.PailPriv.fromObject(object.pailPrivKey);
            }
            return message;
        };
        /**
         ...
         * @memberof two_party_ecdsa_key_gen.KeyShare1
         * @static
         * @param {two_party_ecdsa_key_gen.KeyShare1} message KeyShare1
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        KeyShare1.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
                object.x1 = "";
                object.Q = null;
                object.pailPubKey = null;
                object.pailPrivKey = null;
            }
            if (message.x1 != null && message.hasOwnProperty("x1"))
                object.x1 = message.x1;
            if (message.Q != null && message.hasOwnProperty("Q"))
                object.Q = $root.basic_type.CurvePoint.toObject(message.Q, options);
            if (message.pailPubKey != null && message.hasOwnProperty("pailPubKey"))
                object.pailPubKey = $root.basic_type.PailPub.toObject(message.pailPubKey, options);
            if (message.pailPrivKey != null && message.hasOwnProperty("pailPrivKey"))
                object.pailPrivKey = $root.basic_type.PailPriv.toObject(message.pailPrivKey, options);
            return object;
        };
        /**
         ...
         * @returns {Object.<string,*>} JSON object
         */
        KeyShare1.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
        return KeyShare1;
    })();
    two_party_ecdsa_key_gen.KeyShare2 = (function () {
        /**
         * Properties of a KeyShare2.
         * @memberof two_party_ecdsa_key_gen
         * @interface IKeyShare2
         * @property {string|null} [x2] KeyShare2 x2
         * @property {basic_type.ICurvePoint|null} [Q] KeyShare2 Q
         * @property {basic_type.IPailPub|null} [pailPubKey] KeyShare2 pailPubKey
         * @property {string|null} [cypher_x1] KeyShare2 cypher_x1
         */
        /**
         * Constructs a new KeyShare2.
         * @memberof two_party_ecdsa_key_gen
         * @classdesc Represents a KeyShare2.
         * @implements IKeyShare2
         * @constructor
         * @param {two_party_ecdsa_key_gen.IKeyShare2=} [properties] Properties to set
         */
        function KeyShare2(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * KeyShare2 x2.
         * @member {string} x2
         * @memberof two_party_ecdsa_key_gen.KeyShare2
         * @instance
         */
        KeyShare2.prototype.x2 = "";
        /**
         * KeyShare2 Q.
         * @member {basic_type.ICurvePoint|null|undefined} Q
         * @memberof two_party_ecdsa_key_gen.KeyShare2
         ...
         * @instance
         */
        KeyShare2.prototype.pailPubKey = null;
        /**
         * KeyShare2 cypher_x1.
         * @member {string} cypher_x1
         * @memberof two_party_ecdsa_key_gen.KeyShare2
         ...
         * @static
         * @param {two_party_ecdsa_key_gen.IKeyShare2=} [properties] Properties to set
         * @returns {two_party_ecdsa_key_gen.KeyShare2} KeyShare2 instance
         */
        KeyShare2.create = function create(properties) {
            return new KeyShare2(properties);
        };
        /**
         ...
         * @memberof two_party_ecdsa_key_gen.KeyShare2
         * @static
         * @param {two_party_ecdsa_key_gen.IKeyShare2} message KeyShare2 message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        KeyShare2.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.x2 != null && Object.hasOwnProperty.call(message, "x2"))
                writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.x2);
            if (message.Q != null && Object.hasOwnProperty.call(message, "Q"))
                $root.basic_type.CurvePoint.encode(message.Q, writer.uint32(/* id 2, wireType 2 =*/ 18).fork()).ldelim();
            if (message.pailPubKey != null && Object.hasOwnProperty.call(message, "pailPubKey"))
                $root.basic_type.PailPub.encode(message.pailPubKey, writer.uint32(/* id 3, wireType 2 =*/ 26).fork()).ldelim();
            if (message.cypher_x1 != null && Object.hasOwnProperty.call(message, "cypher_x1"))
                writer.uint32(/* id 4, wireType 2 =*/ 34).string(message.cypher_x1);
            return writer;
        };
        /**
         ...
         * @returns {$protobuf.Writer} Writer
         */
        KeyShare2.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        /**
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {two_party_ecdsa_key_gen.KeyShare2} KeyShare2
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        KeyShare2.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.two_party_ecdsa_key_gen.KeyShare2();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
                        message.x2 = reader.string();
                        break;
                    case 2:
                        message.Q = $root.basic_type.CurvePoint.decode(reader, reader.uint32());
                        break;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        KeyShare2.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        KeyShare2.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.x2 != null && message.hasOwnProperty("x2"))
                if (!$util.isString(message.x2))
                    return "x2: string expected";
            if (message.Q != null && message.hasOwnProperty("Q")) {
                var error = $root.basic_type.CurvePoint.verify(message.Q);
                if (error)
                    return "Q." + error;
         ...
         * @returns {two_party_ecdsa_key_gen.KeyShare2} KeyShare2
         */
        KeyShare2.fromObject = function fromObject(object) {
            if (object instanceof $root.two_party_ecdsa_key_gen.KeyShare2)
                return object;
            var message = new $root.two_party_ecdsa_key_gen.KeyShare2();
            if (object.x2 != null)
                message.x2 = String(object.x2);
            if (object.Q != null) {
                if (typeof object.Q !== "object")
                    throw TypeError(".two_party_ecdsa_key_gen.KeyShare2.Q: object expected");
                message.Q = $root.basic_type.CurvePoint.fromObject(object.Q);
            }
            if (object.pailPubKey != null) {
                if (typeof object.pailPubKey !== "object")
                    throw TypeError(".two_party_ecdsa_key_gen.KeyShare2.pailPubKey: object expected");
                message.pailPubKey = $root.basic_type.PailPub.fromObject(object.pailPubKey);
            }
            if (object.cypher_x1 != null)
                message.cypher_x1 = String(object.cypher_x1);
         ...
         * @memberof two_party_ecdsa_key_gen.KeyShare2
         * @static
         * @param {two_party_ecdsa_key_gen.KeyShare2} message KeyShare2
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        KeyShare2.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
         ...
         * @returns {Object.<string,*>} JSON object
         */
        KeyShare2.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
        return KeyShare2;
    })();
    return two_party_ecdsa_key_gen;
})();
...
module.exports = $root;
//# sourceMappingURL=two_party_ecdsa_key_gen.js.map